...
const RatingsSlide = ({ initialRating = 1200, highestRating = 1000 }) => {
    ...
    const animatedRating = useAnimatedNumber(
        viewState === "stats" ? highestRating : 0,
        400
    );

    let subtext = "";
    if (growth >= 400)
        subtext = "You either started recently or you're too good.";
    else if (growth >= 200) subtext = "Well done.";
    else if (growth > 0) subtext = "It's an increase.";
